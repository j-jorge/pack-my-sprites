...
pms::grammar::definition<ScannerT>::
...
template<typename ScannerT>
pms::grammar::definition<ScannerT>::definition( const grammar& self )
{
...
template<typename ScannerT>
void pms::grammar::definition<ScannerT>::initialize_error_parsers()
{
  m_error_autosize =
