...
bool pms::sprite_sheet_builder::sprite_area_comp::operator()
  ( const spritedesc::sprite& a, const spritedesc::sprite& b ) const
{
  return a.result_box.area() > b.result_box.area();
}

bool pms::sprite_sheet_builder::sprite_height_comp::operator()
  ( const spritedesc::sprite& a, const spritedesc::sprite& b ) const
{
...
bool pms::sprite_sheet_builder::find_place_for
