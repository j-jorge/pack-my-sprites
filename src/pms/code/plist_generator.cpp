...
void pms::plist_generator::generate
...
void pms::plist_generator::generate_plist
...
std::string pms::plist_generator::get_plist_header() const
{
...
std::string pms::plist_generator::get_plist_body( spritedesc desc ) const
{
...
std::string pms::plist_generator::get_frames_entry( spritedesc desc ) const
{
...
std::string
pms::plist_generator::get_sprite_entry( spritedesc::sprite sprite ) const
{
...
std::string pms::plist_generator::get_metadata_entry( spritedesc desc ) const
{
  std::ostringstream result;
