...
void pms::css_generator::generate
( const std::string& spritedesc_file_path, const sprite_sheet& sheet ) const
{
...
void pms::css_generator::generate_css
...
void pms::css_generator::generate_css_class
...
void pms::css_generator::generate_css_class_rotated
( std::ostream& os, const spritedesc::sprite& sprite,
  const std::string& image_path ) const
{
...
void pms::css_generator::generate_css_class_normal
( std::ostream& os, const spritedesc::sprite& sprite,
  const std::string& image_path ) const
{
  const int x( sprite.result_box.position.x );
...
std::string pms::detail::make_class_name( const std::string& sprite_name )
{
  std::string::size_type p( sprite_name.find_first_of( '.' ) );
