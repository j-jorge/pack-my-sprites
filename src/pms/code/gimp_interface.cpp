...
pms::gimp_interface::gimp_interface()
{
...
std::string pms::gimp_interface::run
...
std::string
pms::gimp_interface::execute_gimp_scheme_process( std::string script ) const
{
  int in_fd, out_fd;
...
pid_t
pms::gimp_interface::open_gimp_process( int& in_fd, int& out_fd ) const
{
  int pipe_in[2];
  int pipe_out[2];
...
std::string pms::gimp_interface::get_scheme_path( std::string filename ) const
{
