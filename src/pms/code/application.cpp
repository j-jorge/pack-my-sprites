...
pms::sprite_sheet pms::application::read_spritedesc_stdin() const
{
  return read_spritedesc_file( ".", std::cin );
}

pms::sprite_sheet
pms::application::read_spritedesc_file( std::string file_name ) const
{
...
( std::string directory, std::istream& in ) const
{
  ...
  p.run( result.image, result.description, in );
...
void pms::application::dump_sprite_sheet( sprite_sheet sheet ) const
{
