...
MaxRectsBinPack::MaxRectsBinPack(bool allowRotate, int width, int height)
{
	Init(allowRotate, width, height);
}

void MaxRectsBinPack::Init(bool allowRotate, int width, int height)
{
